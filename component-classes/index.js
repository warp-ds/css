...
export const expandable = {
  ...
  chevronExpand: 'transform transition-transform transform-gpu ease-in-out -rotate-180',
  chevronCollapse: 'transform transition-transform transform-gpu ease-in-out rotate-180',
