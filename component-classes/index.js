...
export const ribbon = {
  ...
  info: 'i-border-$color-badge-info-background i-bg-$color-badge-info-background s-text',
  success: 'i-border-$color-badge-positive-background i-bg-$color-badge-positive-background s-text',
  warning: 'i-border-$color-badge-warning-background i-bg-$color-badge-warning-background s-text',
  error: 'i-border-$color-badge-negative-background i-bg-$color-badge-negative-background s-text',
  disabled: 'i-border-$color-badge-disabled-background i-bg-$color-badge-disabled-background s-text',
  sponsored: 'i-border-$color-badge-price-background i-bg-$color-badge-price-background s-text-inverted',
  neutral: 'i-border-$color-badge-neutral-background i-bg-$color-badge-neutral-background s-text',
...
export const badge = {
  ...
  neutral: 'i-bg-$color-badge-neutral-background s-text',
  info: 'i-bg-$color-badge-info-background s-text',
  positive: 'i-bg-$color-badge-positive-background s-text',
  warning: 'i-bg-$color-badge-warning-background s-text',
  negative: 'i-bg-$color-badge-negative-background s-text',
  disabled: 's-bg-disabled s-text',
  price: 'i-bg-$color-badge-price-background s-text-inverted',
  notification: 's-bg-notification s-text-notification',
...
export const slider = {
  ...
  thumbEnabled:
    'border-2 i-shadow-$shadow-slider cursor-pointer s-bg-primary s-border-selected hover:s-bg-primary-hover hover:s-border-selected-hover hover:i-shadow-$shadow-slider-handle-hover active:s-bg-primary-active active:s-border-selected-active active:i-shadow.$shadow-slider-handle-active focus:i-shadow-$shadow-slider-handle-hover focus:s-border-selected-hover focus:s-bg-primary-hover',
...
export const step = {
  ...
  stepDotActive: 's-border-selected s-bg-primary',
...
export const card = {
  ...
  cardSelected:
    's-border-selected s-bg-selected hover:s-border-selected-hover hover:s-bg-selected-hover active:s-border-selected-active',
...
export const toast = {
  ...
  toast: 'flex group p-8 mt-16 rounded-8 border-2 w-full pointer-events-auto transition-all s-text',
  positive: 's-bg-positive-subtle s-border-positive',
  warning: 's-bg-warning-subtle s-border-warning-subtle',
  negative: 's-bg-negative-subtle s-border-negative-subtle',
...
export const tab = {
  tab: 'grid items-center font-bold gap-8 focusable antialias p-16 pb-8 border-b-4 bg-transparent s-text-subtle border-transparent hover:s-text-link hover:s-border-selected',
...
export const buttonGroupItem = {
  wrapper: 'relative s-text s-bg hover:i-bg-$color-buttongroup-utility-background-hover active:s-text active:i-bg-$color-buttongroup-utility-background-selected',
  ...
  selected: 'z-30 s-text! i-bg-$color-buttongroup-utility-background-selected!',
};
