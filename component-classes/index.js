...
export const toggle = {
  ...
  checkboxInvalid: 'before:s-bg before:s-border-negative before:rounded-2 hover:before:s-bg-negative-subtle-hover hover:before:s-border-negative-hover peer-checked:before:bg-center peer-checked:before:bg-[url(var(--w-form-check-mark))] peer-checked:before:s-bg-negative peer-checked:peer-hover:before:s-bg-negative-hover peer-checked:peer-hover:before:s-border-negative-hover', // isCheckbox && !isIndeterminate && isInvalid && !isDisabled
  checkboxDisabled: 'before:s-bg-disabled-subtle before:s-border-disabled pointer-events-none before:rounded-2 peer-checked:before:bg-center peer-checked:before:bg-[url(var(--w-form-check-mark))]', // isCheckbox && !isIndeterminate && !isInvalid && isDisabled
  ...
  indeterminateDisabled: 'before:content-["–"] before:rounded-2 before:flex before:items-center before:justify-center before:text-center before:font-bold before:s-icon-inverted peer-indeterminate:before:s-border-disabled peer-indeterminate:before:s-bg-disabled-subtle peer-indeterminate:hover:before:s-border-disabled peer-indeterminate:hover:before:s-bg-disabled-subtle', // isCheckbox && isIndeterminate && !isInvalid && isDisabled
