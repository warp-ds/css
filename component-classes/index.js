...
export const toggle = {
  ...
  labelDisabled: 'pointer-events-none',
  checkbox: 'before:s-bg before:rounded-2 hover:before:s-border-primary hover:before:s-bg-hover',
...
export const attention = {
  ...
  popover: 'bg-[--w-s-color-surface-elevated-300] border-[--w-s-color-surface-elevated-300] s-text rounded-8 p-16 drop-shadow-m',
